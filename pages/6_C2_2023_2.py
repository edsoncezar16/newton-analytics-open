...
data = nh.modern_get_processed_data(
    filepath=DATA_ROOT / "2023-2" / "lists_exams" / "C2-2023-2.csv",
    lists_indices=list(range(7, 13)) + list(range(18, 23)) + list(range(28, 33)),
    exams_indices=list(range(13, 17)) + list(range(23, 27)) + list(range(33, 37)),
    grades_indices=[17, 27, 37],
)

M, A, B, C, D = nh.compute_quantitatives(data)

st.title("Análises de C2 do período 2023/2")
